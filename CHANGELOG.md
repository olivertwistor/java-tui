...
This file chronicles all noteworthy changes to this project over time. It is based on [Keep a changelog 1.0.0]. The
versioning scheme I use for the project is [Semantic Versioning 2.0.0].

## [Unreleased]

- Added
	- Unit testing for the `Terminal` class.
	- Overloaded `Terminal#write`, `Terminal#writeLine`, `Terminal#readString`, `Terminal#readInt` and
	  `Terminal#readBoolean`, adding parameters for input streams and print streams. This is done in order to make the
	  library more generic and not just rely on standard in- and output.
- Changed
